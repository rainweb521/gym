...
(function($) {
	$.extend({
		...
		operate:{
            ...
            checkin: function(id) {
                var url = $.table._option.checkinUrl+id;
                $.modal.open("签到" + $.table._option.modalName, url);
            },
            physicallist: function(id) {
                var url = $.table._option.physicallistUrl.replace("{id}", id);
                $.modal.open("体能记录" + $.table._option.modalName, url);
            },
            customerlist: function(id) {
                var url = $.table._option.customerUrl.replace("{id}", id);
                $.modal.open("已购课程" + $.table._option.modalName, url);
            },
            comment: function(id) {
                var url = $.table._option.commentUrl.replace("{id}", id);
                $.modal.open("评价" + $.table._option.modalName, url);
            },
            physical: function(id) {
                var url = $.table._option.physicalUrl.replace("{id}", id);
                $.modal.open("添加体能" + $.table._option.modalName, url);
            },
			remove:function(id){
            ...
            buy:function(id){
                $.modal.confirm("确定购买该" +$.table._option.modalName+ "课程吗？", function() {
                    var url =  $.table._option.buyUrl;
                    var data = {
                        "ids": id
                    };
                    $.operate.submit(url, "post", "json", data);
